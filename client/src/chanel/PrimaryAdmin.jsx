...
class CreateCard extends Component {
  ...
  extractChannelId = () => {
    const path = window.location.pathname; // like /chnel/12345
    const parts = path.split("/");
    if (parts.length > 2) {
      this.setState({ channelId: parts[2] });
    }
  };
  ...
  handleSubmit = (event) => {
    ...
    formData.append("channel_id", this.state.channelId); // ✅ Save Channel ID
      ...
      <div className="create-card-container">
        <div className="form-container">
          ...
          {this.state.channelId && (
            <div className="channel-id-display">
              <strong>Channel ID:</strong> {this.state.channelId}
            </div>
          )}
